...
Source: [Google Scholar](https://scholar.google.com/citations?user=nxVowRQAAAAJ) (updated `r Sys.Date()`)

- **Total citations:** `r profile$total_cites` — how many times my work has been referenced by other researchers
- **h-index:** `r profile$h_index` — I have `r profile$h_index` papers each cited at least `r profile$h_index` times
- **i10-index:** `r profile$i10_index` — how many of my papers have been cited at least 10 times
...
2026-present, Co-Director (with Dr. Emily Holtz), AI, Data, and Educational Partnerships at the University of Tennessee (ADEPT) Center\
University of Tennessee, Knoxville
...
*\$9,330,317 as Principal Investigator (PI) or Co-PI*

## PI or Co-PI

2025-2026, PI, *Tennessee Collaborative for the Presidential AI Challenge* (\$84,450). AI Tennessee Initiative, University of Tennessee, Knoxville.
...
National Academies of Sciences, Engineering, and Medicine. (2026). *Data and Computing in K-12 Education: Foundational Competencies*. Washington, DC: National Academies Press. <https://doi.org/10.17226/29303>. *N.b.* I contributed as a committee member.
...
## Editor-Reviewed Articles Published in Journals (14)

Kimmons, R., Rosenberg, J. M., Ali, F., & West, R. E. (2026). Trends and topics in educational technology, 2026 edition. *TechTrends.* <https://doi.org/10.1007/s11528-026-01193-2>

Rosenberg, J. M., Bonvini, M., Bray, A., Gong, R., & Yu, B. (2026). Teaching veridical data science: A panel interview with Matteo Bonvini, Andrew Bray, Ruobin Gong, and Bin Yu. *Journal of Statistics and Data Science Education, 34*(2), 127-143. <https://doi.org/10.1080/26939169.2026.2632565>
