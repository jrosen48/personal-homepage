...
My research program spans two interconnected lines of work in educational data science. In the first, I use new data sources and computational methods to describe and question educational systems. This has included studies of educators' professional learning through social media, critical investigations of how K-12 institutions' social media practices compromise student privacy, and methodological work integrating machine learning with qualitative analysis. In the second, I work to weave data science into teaching and learning, with a particular focus on science education. This includes developing approaches for teaching statistical reasoning — especially Bayesian thinking — in K-12 classrooms, building tools and curricula that make data science accessible to newcomers, and contributing to the establishment of educational data science as a field through widely used open-source software, a co-authored book (*Data Science in Education Using R, Routledge*, 2020), and a synthesis of what is known about K-12 data science learning. Across both lines, I program in R and Python, apply advanced statistical methods (particularly multi-level models), develop open-source tools, and center partnering *with* teachers. My current and near-future work extends these lines into multimodal learning analytics, community-based data science learning, and the roles of generative AI in education.
...
Steering Committee Member and Affiliated Researcher, [Center for the Dynamics of Cultural Complexity (DySoC)](https://artsci.utk.edu/research-and-creative-activity/research-centers-and-institutes/dysoc/#people), University of Tennessee, Knoxville (2024-present)

Affiliated Researcher, [AmplifyLearn.AI](https://www.amplifylearn.ai/), University of Washington (2024-present)
...
Rosenberg, K., & Rosenberg, J.M. (in press, anticipated release winter 2026-2027). Little kids, big adventures: A guide to family hikes around Knoxville. UT Press. <https://familyhikesaroundknox.com/>
...
## Articles Published in Refereed Journals (65)
...
## Commissioned Papers, White Papers, Reports, and Articles in the Popular Press (6)
...
## Editor-Reviewed Articles Published in Journals (12)
...
## Contributions to Edited Volumes (13)

Rosenberg, J., King, A., Swartzentruber, R., & Carpenter, J. (2025). The strengths and drawbacks of measuring self-reported and digitally traced social networks. In *Handbook of Social Network Analysis and Education* (pp. 102-113). Edward Elgar Publishing. https://www.elgaronline.com/edcollchap/book/9781035312191/chapter7.xml

Rosenberg, J. M., Bhidiya, H., & Pritchard, C. (2025). Triangulating computational and qualitative methods to measure scientific uncertainty. In P. Wulff, M. Kubsch, & C. Krist (Eds.), *Applying machine learning in science education research: When, how, and why?* (pp. 313–332). Springer.

Rosenberg, J. (in press). *Comparing self-report and digital trace measures of social networks.* In N. Kolleck (Ed.), *Handbook of social network analysis and education research* (Research Handbooks on Social Networks series). Edward Elgar Publishing.

Dai, T., Rosenberg, J. M., & +Lawson, M. A. (2022). Data representations and visualizations in educational research. In T. L. Good & M. McCaslin (*Eds.*), Educational Psychology Section; D. Fisher (*Ed.*), *Routledge encyclopedia of education*. Taylor & Francis: New York, NY. <https://doi.org/10.4324/9781138609877-REE148-1>
...
## Papers Published in Refereed Conference Proceedings (34)

Chen, C., Zhao, Y., Rosenberg, J. M., & Hodge, L. L. (2025, August). Mapping the Research Landscape of Culturally Relevant Pedagogy in Computing Education: A Topic Modeling Approach. In *Proceedings of the 2025 ACM Conference on International Computing Education Research* V. 2 (p. 20).

Demirci, S., Dogucu, M., Zieffler, A. & Rosenberg, J. (2024) The Learning Difficulties of Introductory Data Science Students. In E. Jones (Ed) *Proceedings of the International Association for Statistical Education Satellite Conference*. https://www.iase-pub.org/conference_proceedings/IASECP/article/view/254/247
...
[Study: Schools' Social Media Posts May Be Compromising Student Privacy](https://www.aera.net/Newsroom/Study-Schools-Social-Media-Posts-May-Be-Compromising-Student-Privacy), *American Educational Research Association*, November 2, 2022
